...
public class EstiloTablaRenderer extends DefaultTableCellRenderer {
    ...
    public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column) {
        ...
        this.setBorder(null);
        this.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 1, 1, 1, new java.awt.Color(254, 254, 254)));
        
        if (row % 2 == 0) {
            componenete.setForeground(new Color(197,29,116));
        ...
        if (isSelected) {
            ...
            componenete.setBackground(new Color(195, 80, 140));
