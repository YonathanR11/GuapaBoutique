...
public class CancelarVenta extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("¿Desea cancelar esta venta?");
    ...
    public void cancelar(){
        ...
        Principal.Administrador.contadordeceldas=0;
        subtotalventas=0;
...
//                    System.out.println("Existencia: " + ExistenciaInicial[i]);
    ...
    public void ActualizarStock() {
        for (int i = 0; i < tablaVentas.getRowCount(); i++) {
            Object idproducto = tablaVentas.getValueAt(i, 0);
//            Object vendidos = tablaVentas.getValueAt(i, 3);
            String id = String.valueOf(idproducto);
//            System.out.println("Codigo: " + id);
            try {
...
//               System.out.println("NOW: "+totalExistenciaNow);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                CancelarVenta dialog = new CancelarVenta(new javax.swing.JFrame(), true);
